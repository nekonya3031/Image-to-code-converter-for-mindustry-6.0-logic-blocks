...
public class Parser {
    public static Schematics aaa = null;

    public static void main(String[] args) throws IOException {
        System.out.print("Starting load picture");
        BufferedImage bi = ImageIO.read(new File("image.png"));
        Schematics.write(parse(bi), new Fi("image.msch"));
    }

    public static Schematic parse(BufferedImage bi) {
        ...
        while (x < w) {
            ...
            while (y < h) {
                ...
                int r = ((baka >> 16) & 0xFF) / 12;
                int g = ((baka >> 8) & 0xFF) / 12;
                int b = ((baka) & 0xFF) / 12;
    ...
    public static Schematic generate(String[][] c, int x, int y) {
